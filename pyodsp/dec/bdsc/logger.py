...
class BdScLogger(ILogger):
    def __init__(self, level: int = logging.INFO):
        # Create a logger object
        self.logger = logging.getLogger("Benders Decomposition with Scaled Cuts")
    ...
    def log_initialization(self, **kwargs):
        self.logger.info("Starting Benders decomposition with scaled cuts")
